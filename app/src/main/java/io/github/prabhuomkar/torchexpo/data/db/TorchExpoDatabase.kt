...
import io.github.prabhuomkar.torchexpo.data.db.dao.CollectionDao
import io.github.prabhuomkar.torchexpo.data.db.dao.ModelDao
import io.github.prabhuomkar.torchexpo.data.db.dao.PublisherDao
...
@Database(
    entities = [Model::class, Task::class, Collection::class, Publisher::class],
    version = 1,
    exportSchema = false
)
